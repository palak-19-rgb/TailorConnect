...
function Chatbot() {
    ...
    const sessionId = "tailor_" + (localStorage.getItem("email") || "guest");
    ...
    const sendMessage = async () => {
        ...
        try {
            const res = await fetch("http://localhost:1000/chatbot/tailor-message", {
                method: "POST",
